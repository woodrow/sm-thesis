...
\begin{center}
    ...
    \caption[Growth of the Internet (DFZ) routing table, 1994-present]
...
operators \fbox{cite}, engineering efforts have allowed the capabilities of
...
\begin{center}
    ...
    \vspace{-2em}\\
    \caption[Normalized growth factors of the Internet routing table relative
    to Moore's Law]{Normalized growth factors (smoothed over a 2 year window)
...
exclude others' routes from the routing table, but the value of the interdomain
routing system is in global reachability, and so it is difficult to exclude
routes without potentially reducing the utility of the network's connectivity
to the Internet.
